...
Feature: Getting a customer
  ...
  Scenario: Getting an existing customer
    ...
    Then the status code is for customer with id 1 returned the status 200 and status message ""
  ...
  Scenario: Getting a non existent customer
    ...
    Then the status code is for customer with id 5000 returned the status 404 and status message "no customer with given id"
